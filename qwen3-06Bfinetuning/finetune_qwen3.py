...
# Import auto-shutdown functionality
from auto_stop import auto_shutdown
...
if __name__ == "__main__":
    # Start auto-shutdown timer (60 seconds = 1 minute)
    # Set AUTO_STOP_DISABLED=1 environment variable to disable auto-shutdown
    if os.environ.get("AUTO_STOP_DISABLED") != "1":
        auto_shutdown(delay_seconds=60)
        print("[Auto-Shutdown] Timer started - instance will shutdown in 1 minute")
    else:
        print("[Auto-Shutdown] Auto-shutdown disabled via environment variable")
